# PZEM-004T 
It includes the Schematic of the the tests of pzem-004t when two coils are in series with each other due to which the power in first coil has power equal to the sum of two loads
